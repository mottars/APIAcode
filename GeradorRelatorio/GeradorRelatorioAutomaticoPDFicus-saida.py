...
def cargasAplicadas(doc, num_topico, num_subtopico, num_figura, pressao_int, pressao_ext, temperatura, momento, forca_axial,  tipo_de_duto = None, arquivo_pressao_interna = None, arquivo_pressao_externa = None, arquivo_momento = None, arquivo_temperatura = None, arquivo_forca_axial = None):
	...
	background = Image.open(os.path.join(os.getcwd(), 'GeradorRelatorio', "base2.png"))
	img_p_interna = Image.open(os.path.join(os.getcwd(), 'GeradorRelatorio', "pressao_interna.png"))
	img_p_externa = Image.open(os.path.join(os.getcwd(), 'GeradorRelatorio', "pressao_externa.png"))
	img_f_axial = Image.open(os.path.join(os.getcwd(), 'GeradorRelatorio', "forca_axial.png"))
	img_momento = Image.open(os.path.join(os.getcwd(), 'GeradorRelatorio', "momento.png"))
